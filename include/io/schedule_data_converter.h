...
struct BLF_ClockTime : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_ClockTime>(
                getName(), blf::arg("hours", &BLF_ClockTime::hours), blf::arg("minutes", &BLF_ClockTime::minutes)));
        }
};
...
struct BLF_FileInfo : BLF_Base {
        ...
        BLF_FileInfo(const TimeWrapper& fileEditTime)
            : editDate(fileEditTime.getDateUTC()), editTime(fileEditTime.getClockTimeUTC()) {
        }

        TimeWrapper getEditTime() const {
            return TimeWrapper(editDate.getDate(), editTime.getClockTime());
        }

        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_FileInfo>(
                getName(),
...
struct BLF_ElementInfo : BLF_Base {
        ...
        TimeWrapper getCreationTime() const {
            return TimeWrapper(creationDate.getDate(), creationTime.getClockTime());
        }

        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_ElementInfo>(
                getName(),
...
struct BLF_Element<bool> : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Element<bool>>(
                getName(),
...
struct BLF_Element<int> : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Element<int>>(
                getName(),
...
struct BLF_Element<double> : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Element<double>>(
                getName(),
...
struct BLF_Element<std::string> : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Element<std::string>>(
                getName(),
...
struct BLF_Element<SingleSelectContainer> : BLF_Base {
        ...
        Element<SingleSelectContainer> getElement() const {
            Element<SingleSelectContainer> singleSelect =
                Element<SingleSelectContainer>(SCH_SELECT, SingleSelectContainer(), info.getCreationTime());
            singleSelect.getValueReference().replaceSelection(getSelection());
            return singleSelect;
        }

        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Element<SingleSelectContainer>>(
                getName(),
...
struct BLF_Element<SelectContainer> : BLF_Base {
        ...
        Element<SelectContainer> getElement() const {
            Element<SelectContainer> select =
                Element<SelectContainer>(SCH_MULTISELECT, SelectContainer(), info.getCreationTime());
            select.getValueReference().replaceSelection(getSelection());
            return select;
        }

        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Element<SelectContainer>>(
                getName(),
...
struct BLF_Element<WeekdayContainer> : BLF_Base {
        ...
        Element<WeekdayContainer> getElement() const {
            Element<WeekdayContainer> weekday =
                Element<WeekdayContainer>(SCH_WEEKDAY, WeekdayContainer(), info.getCreationTime());
            weekday.getValueReference().replaceSelection(getSelection());
            return weekday;
        }

        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Element<WeekdayContainer>>(
                getName(),
...
struct BLF_Element<TimeContainer> : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Element<TimeContainer>>(
                getName(),
...
struct BLF_Element<DateContainer> : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Element<DateContainer>>(
                getName(),
...
struct BLF_FilterRule : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_FilterRule<T>>(
                getName(),
...
struct BLF_Filter : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Filter<T>>(
                getName(),
...
struct BLF_FilterGroup : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_FilterGroup<T>>(
                getName(),
...
struct BLF_SelectOption : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_SelectOption>(
                getName(), blf::arg("name", &BLF_SelectOption::name), blf::arg("colorEnum", &BLF_SelectOption::colorEnum)));
        }
};
...
struct BLF_SelectOptions : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_SelectOptions>(
                getName(), blf::arg("options", &BLF_SelectOptions::options, definitions.get<BLF_SelectOption>())));
        }
};
...
struct BLF_Column : BLF_Base {
        ...
        static void addDefinition(ObjectDefinitions& definitions) {
            definitions.add(definitions.getObjectTable().define<BLF_Column<T>>(
                getName(),
