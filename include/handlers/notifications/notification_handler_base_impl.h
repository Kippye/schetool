...
class NotificationHandlerImpl {
    ...
    public:
        ...
        virtual bool showNotification(const std::string& title, const std::string& content, unsigned int timeout_sec) {
            return false;
        }
        virtual bool showItemNotification(const std::string& name,
