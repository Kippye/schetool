...
class NotificationHandler
{
    ...
    public:
        ...
        bool showItemNotification(const std::string& name, const ClockTimeWrapper& beginning, const ClockTimeWrapper& end, const ItemNotificationData& itemNotificationData);
};