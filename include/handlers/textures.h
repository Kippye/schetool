...
{
    private:
        const static unsigned char missing[];

        struct { size_t size; size_t width; size_t height; IMAGE_FORMAT imageFormat; const unsigned char data[145]; } m_missingTextureData = {
            145,
            16,
            16,
            FORMAT_PNG,
            ...
            0x00, 0x06, 0x50, 0x4c, 0x54, 0x45, 0x00, 0x00, 0x00, 0xf4, 0xa8, 0xff, 0x5c, 0x76, 0xbb, 0xaf,
            0x00, 0x00, 0x00, 0x09, 0x70, 0x48, 0x59, 0x73, 0x00, 0x00, 0x0e, 0xc2, 0x00, 0x00, 0x0e, 0xc2,
            0x01, 0x15, 0x28, 0x4a, 0x80, 0x00, 0x00, 0x00, 0x14, 0x49, 0x44, 0x41, 0x54, 0x18, 0xd3, 0x63,
            0x00, 0x01, 0x41, 0x20, 0xa0, 0x94, 0x41, 0x0d, 0x33, 0x18, 0x18, 0x18, 0x00, 0x32, 0x9f, 0x04,
            0x41, 0xf0, 0x11, 0x00, 0x81, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4e, 0x44, 0xae, 0x42, 0x60,
            0x82}
        };
        ...
        void createTexture(IMAGE_FORMAT imageFormat, GLenum target, GLint level, GLsizei width, GLsizei height, GLint border, GLenum type, const void *pixels) const;
        GLuint createTextureFromData(IMAGE_FORMAT imageFormat, GLenum target, GLint level, GLsizei width, GLsizei height, GLint border, GLenum type, const unsigned char* data, size_t length) const;
	public:
		...
		unsigned char* loadTextureData(const std::filesystem::path& path, int* width, int* height, GLuint* ID = nullptr, bool bind = true, bool flip = false);
};

const inline unsigned char TextureLoader::missing[] =
{
    ...
    
};