...
class DECLSPEC_UUID("79A832A4-47BC-46CD-998A-73DCD7CAF255") NotificationActivator WrlSealed  // WrlFinal
    ...
    public:
        ...
        inline static Event<NotificationActivation, size_t> notificationActivatedEvent =
            Event<NotificationActivation, size_t>();
        virtual HRESULT STDMETHODCALLTYPE Activate(_In_ LPCWSTR appUserModelId,
                    ...
                    if (argString.find(L"completePrevious") != std::string::npos) {
                        ...
                        if (arguments.size() == 2) {
                            ...
                            if (ec != std::errc{}) {
                                ...
                                notificationActivatedEvent.invoke(NotificationActivation::PreviousMarkedDone,
...
class NotificationHandlerWinImpl : public NotificationHandlerImpl {
    private:
        inline static const std::vector<std::string> m_scheduleProgressMessages = {
            "Awesome!", "Good job :)", "Working...", "Just a few left!", "Do you like ice cream?"};
        static const constexpr char* const m_notificationFormat = "<toast>"
                                                                  "<visual>"
                                                                  ...
                                                                  "</visual>"
                                                                  "</toast>";
        static const constexpr char* const m_itemNotificationFormat =
        ...
        std::function<void(NotificationActivation, size_t)> notificationActivatedListener =
            [&](NotificationActivation activationType, size_t notificationID) {
