...
void ScheduleCore::setScheduleName(const std::string& name)
{
...
std::string ScheduleCore::getScheduleName()
{
...
const std::vector<Column>& ScheduleCore::getColumns()
{
    return m_schedule;
}

std::vector<Column>& ScheduleCore::getMutableColumns()
{
    return m_schedule;
}
