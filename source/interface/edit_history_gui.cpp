        ...
        for (size_t i = 0; i < editHistory.size(); i++) {
            ...
            switch (editHistory[i]->getType()) {
                ...
                case (ScheduleEditType::ColumnPropertyChange): {
                    ...
                    sprintf(buf,
                            "Column %s property %s at %zu##%zu",
                            columnPropertyEdit->getColumnName().c_str(),
                            editedProperty == COLUMN_PROPERTY_NAME
                                ? "Name"
                ...
                case (ScheduleEditType::ColumnReset): {
                    ...
                    sprintf(buf,
                            "Reset Column %s of type %s at %zu##%zu",
                ...
                case (ScheduleEditType::FilterGroupAddOrRemove): {
                    ...
                    sprintf(buf,
                            "%c Filter group #%zu of Column %zu##%zu",
                ...
                case (ScheduleEditType::FilterGroupChange): {
                    ...
                    sprintf(buf,
                            "Edit filter group #%zu of Column %zu %s (%s -> %s) ##%zu",
                            ...
                            operatorChanged ? filter_consts::logicalOperatorStrings.at(filterGroupChangeEdit->getPrevOperator())
                                            : (enabledChanged ? std::to_string(filterGroupChangeEdit->getPrevEnabled()).c_str()
                                                              : filterGroupChangeEdit->getPrevName().c_str()),
                            operatorChanged ? filter_consts::logicalOperatorStrings.at(filterGroupChangeEdit->getNewOperator())
                                            : (enabledChanged ? std::to_string(filterGroupChangeEdit->getNewEnabled()).c_str()
                                                              : filterGroupChangeEdit->getNewName().c_str()),
                            i);
                    break;
                }
                case (ScheduleEditType::FilterAddOrRemove): {
                    ...
                    sprintf(buf,
                            "%c Filter #%zu in group #%zu of Column %zu##%zu",
                ...
                case (ScheduleEditType::FilterChange): {
                    ...
                    sprintf(buf,
                            "Edit filter #%zu in group #%zu of Column %zu operator (%s -> %s)##%zu",
                ...
                case (ScheduleEditType::FilterRuleAddOrRemove): {
                    ...
                    sprintf(buf,
                            "%c Filter rule #%zu in filter #%zu in group #%zu of Column %zu##%zu",
                ...
                case (ScheduleEditType::FilterRuleChange): {
                    ...
                    sprintf(buf,
                            "Edit filter rule #%zu in filter #%zu in group #%zu of Column %zu (%s -> %s)##%zu",
